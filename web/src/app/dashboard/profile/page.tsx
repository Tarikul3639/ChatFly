...
export default function ProfilePage() {
  ...
  useEffect(() => {
    ...
    const userData = { id: 1, name: "John Doe", email: "john@example.com", role: "student" }
    if (!userData) {
      router.push("/login")
      return
    }
  ...
  const handleSaveProfile = () => {
    ...
    localStorage.setItem("chatfly-user", JSON.stringify(updatedUser))
    setUser(updatedUser)
  ...
  const classrooms = [
    { name: "Mathematics 101", role: "Student", joined: "Sep 2024", messages: 45 },
    { name: "Physics Lab", role: "Student", joined: "Sep 2024", messages: 23 },
    { name: "Computer Science", role: "Student", joined: "Aug 2024", messages: 67 },
    { name: "Literature Club", role: "Member", joined: "Oct 2024", messages: 12 },
  ]

  if (!user) return null

  return (
    <div className="h-[calc(100dvh-4rem)] overflow-y-auto bg-gradient-to-br from-blue-50 via-white to-indigo-50">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600 flex items-center space-x-2">
                <Badge
                  variant="secondary"
                  className={`${user?.role === "teacher" ? "bg-purple-100 text-purple-600" : "bg-blue-100 text-blue-600"}`}
                >
                  {user?.role || "Student"}
                </Badge>
                <span>•</span>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm text-gray-500">Contact admin to change your role</span>
                  </div>
                </div>
                <Button
            ...
            <Card className="shadow-lg border-0">
              <CardHeader>
                ...
                <CardDescription>Your ChatFly activity and statistics</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid md:grid-cols-3 gap-4">
                  <div className="text-center p-4 bg-blue-50 rounded-lg">
                    <div className="text-2xl font-bold text-blue-600">{classrooms.length}</div>
                    <div className="text-sm text-blue-700">Classrooms Joined</div>
                  </div>
                  ...
                  <div className="text-center p-4 bg-purple-50 rounded-lg">
                    ...
                    <div className="text-sm text-purple-700">AI Suggestions Used</div>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="shadow-lg border-0">
              <CardHeader>
                ...
                <CardDescription>All classrooms you&apos;ve joined and your activity</CardDescription>
              </CardHeader>
              <CardContent>
                  ...
                  {classrooms.map((classroom, index) => (
                    <div key={index} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                      ...
                      <div className="text-right">
                        <div className="text-sm font-medium text-gray-900">{classroom.messages} messages</div>
          ...
          <div className="space-y-6">
            ...
            <Card className="shadow-lg border-0">
              ...
              <CardContent>
                <p className="text-sm text-gray-600 mb-4">Get support or learn more about ChatFly features</p>
                <div className="space-y-2">
