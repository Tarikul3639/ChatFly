...
export default function ChatList({ onChatSelect, selectedChatId }: ChatListProps) {
  ...
  return (
    <div className="w-full h-[calc(100dvh-4rem)] sm:h-[calc(100dvh)] md:w-80 bg-gray-50 border-r border-gray-200 flex flex-col">
      {/* Header */}
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between">
                  <h3 className="font-medium text-gray-900 truncate text-sm md:text-base">{chat.name}</h3>
